package bia.web.rest;

import bia.config.Constants;
import bia.domain.User;
import bia.repository.UserRepository;
import bia.security.AuthoritiesConstants;
import bia.service.MailService;
import bia.service.UserService;
import bia.service.dto.AdminUserDTO;
import bia.web.rest.errors.BadRequestAlertException;
import bia.web.rest.errors.EmailAlreadyUsedException;
import bia.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link bia.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
